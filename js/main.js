...
function H(a){return 9==a.nodeType?a:a.ownerDocument||a.document}function cb(a){if(a&&"number"==typeof a.length){if(fa(a))return"function"==typeof a.item||"string"==typeof a.item;if(ea(a))return"function"==typeof a.item}return!1}function Wa(a){this.w=a||l.document||document}f=Wa.prototype;f.lb=Va;f.b=function(a){return p(a)?this.w.getElementById(a):a};f.za=function(a,b,c){return ab(this.w,arguments)};f.createElement=function(a){return this.w.createElement(a)};f.createTextNode=function(a){return this.w.createTextNode(String(a))};
...
function Ib(a,b){var c=b.type;c in a.u&&za(a.u[c],b)&&(Fb(b),0==a.u[c].length&&(delete a.u[c],a.La--))}f.ua=function(a){a=a&&a.toString();var b=0,c;for(c in this.u)if(!a||c==a){for(var d=this.u[c],e=0;e<d.length;e++)++b,Fb(d[e]);delete this.u[c];this.La--}return b};f.Ca=function(a,b,c,d){a=this.u[a.toString()];var e=-1;a&&(e=Hb(a,b,c,d));return-1<e?a[e]:null};
f.hasListener=function(a,b){var c=m(a),d=c?a.toString():"",e=m(b);return Fa(this.u,function(a){for(var h=0;h<a.length;++h)if(!(c&&a[h].type!=d||e&&a[h].ya!=b))return!0;return!1})};function Hb(a,b,c,d){for(var e=0;e<a.length;++e){var g=a[e];if(!g.va&&g.listener==b&&g.ya==!!c&&g.Wa==d)return e}return-1};var Jb="closure_lm_"+(1E6*Math.random()|0),Kb={},Lb=0;
...
function Ob(){var a=Qb,b=yb?function(c){return a.call(b.src,b.listener,c)}:function(c){c=a.call(b.src,b.listener,c);if(!c)return c};return b}function Rb(a,b,c,d,e){if(n(b))for(var g=0;g<b.length;g++)Rb(a,b[g],c,d,e);else c=Mb(c),a&&a[Cb]?a.Na(b,c,d,e):a&&(a=Nb(a))&&(b=a.Ca(b,c,!!d,e))&&N(b)}
function N(a){if(!q(a)&&a&&!a.va){var b=a.src;if(b&&b[Cb])Ib(b.T,a);else{var c=a.type,d=a.eb;b.removeEventListener?b.removeEventListener(c,d,a.ya):b.detachEvent&&b.detachEvent(Pb(c),d);Lb--;(c=Nb(b))?(Ib(c,a),0==c.La&&(c.src=null,b[Jb]=null)):Fb(a)}}}function Pb(a){return a in Kb?Kb[a]:Kb[a]="on"+a}function Sb(a,b,c,d){var e=!0;if(a=Nb(a))if(b=a.u[b.toString()])for(b=b.concat(),a=0;a<b.length;a++){var g=b[a];g&&g.ya==c&&!g.va&&(g=Tb(g,d),e=e&&!1!==g)}return e}
...
f.handleEvent=function(a){var b=a.U,c,d,e=b.altKey;z&&"keypress"==a.type?(c=this.da,d=13!=c&&27!=c?b.keyCode:0):(C||A)&&"keypress"==a.type?(c=this.da,d=0<=b.charCode&&63232>b.charCode&&bc(c)?b.charCode:0):Ka&&!C?(c=this.da,d=bc(c)?b.keyCode:0):(c=b.keyCode||this.da,d=b.charCode||0,ic&&(e=this.gb),D&&63==d&&224==c&&(c=191));var g=c=cc(c),h=b.keyIdentifier;c?63232<=c&&c in fc?g=fc[c]:25==c&&a.shiftKey&&(g=9):h&&h in gc&&(g=gc[h]);a=g==this.H;this.H=g;b=new jc(g,d,a,b);b.altKey=e;this.dispatchEvent(b)};
...
nc.prototype.stop=function(a){x(this.S,function(b){b.f==Q||b.stop(a)});this.f=Q;this.endTime=u();this.v("stop");this.ta()};nc.prototype.Rb=function(){this.kb++;this.kb==this.S.length&&(this.endTime=u(),this.f=Q,this.v("finish"),this.ta())};function oc(a){J.call(this);this.Ea=a;this.Ga={}}w(oc,J);var pc=[];f=oc.prototype;f.l=function(a,b,c,d){n(b)||(b&&(pc[0]=b.toString()),b=pc);for(var e=0;e<b.length;e++){var g=M(a,b[e],c||this.handleEvent,d||!1,this.Ea||this);if(!g)break;this.Ga[g.key]=g}return this};
f.Na=function(a,b,c,d,e){if(n(b))for(var g=0;g<b.length;g++)this.Na(a,b[g],c,d,e);else c=c||this.handleEvent,e=e||this.Ea||this,c=Mb(c),d=!!d,b=a&&a[Cb]?a.Ca(b,c,d,e):a?(a=Nb(a))?a.Ca(b,c,d,e):null:null,b&&(N(b),delete this.Ga[b.key]);return this};f.ua=function(){Ea(this.Ga,function(a,b){this.Ga.hasOwnProperty(b)&&N(a)},this);this.Ga={}};f.g=function(){oc.i.g.call(this);this.ua()};f.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented");};function qc(a){var b=a.offsetLeft,c=a.offsetParent;c||"fixed"!=jb(a,"position")||(c=H(a).documentElement);if(!c)return b;if(B)var d=pb(c),b=b+d.left;else 8<=Number(F)&&!(9<=Number(F))&&(d=pb(c),b-=d.left);return mb(c)?c.clientWidth-(b+a.offsetWidth):b};function rc(a,b,c){O.call(this);this.target=a;this.handle=b||a;this.Lb=c||new gb(NaN,NaN,NaN,NaN);this.w=H(a);this.R=new oc(this);a=la(vb,this.R);this.qa?a.call(void 0):(this.la||(this.la=[]),this.la.push(m(void 0)?t(a,void 0):a));this.deltaY=this.deltaX=this.Wb=this.Vb=this.screenY=this.screenX=this.clientY=this.clientX=0;this.Ta=!0;this.fa=!1;this.Sb=!0;this.Hb=0;this.oa=this.lc=!1;M(this.handle,["touchstart","mousedown"],this.Ub,!1,this)}w(rc,O);var sc=l.document&&l.document.documentElement&&!!l.document.documentElement.setCapture;
...
function Tc(a,b){b=Ta(b,a.o(),a.m());a.Xa&&(a.Aa.stop(!0),a.Aa.D());var c=new nc,d,e=Wc(a,b),g=a.s(),h=a.V(),k=Z(a,e),r=$c(a,k);d=a.Da();Math.abs(b-k)<d&&(b=Ta(k+(b>k?d:-d),a.o(),a.m()));Sc(a,e,b);k=$c(a,Z(a,e));d="vertical"==a.C?[Xc(a,e),k.y]:[k.x,e.offsetTop];r=new Ic(e,[r.x,r.y],d,100);r.$(a.G);c.add(r);a.j&&bd(a,e,g,h,k,c);a.Ab&&(e=a.Ab.uc(g,b,100),x(e,function(a){c.add(a)}));a.Aa=c;a.ga().l(c,"end",a.dc);a.Xa=!0;c.play(!1)}
...
this.Ib),this.xb=this.Pa=this.enabled=!1,this.yb=b||null,this.Z=this.ma=this.Bb=null,M(this.element,"click",function(a,b,c){
...
},!1,this),this.map.controls[c||google.maps.ControlPosition.RIGHT_BOTTOM].push(this.element),a.addListener("center_changed",t(function(){this.Pa=!1},this)))});
              
//console.log(b.coords.longitude);              
