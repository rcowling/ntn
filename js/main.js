...
// reset the trail colors back to the original value
function allTrailsStyle(){
 map.data.setStyle(function(feature) {
    ...
    Materialize.toast('Displaying all trails.', 4000)
}
...
map.data.addListener('click', function(event) {
    ...
    if (level == 'BEGINNER') {
         ...
         document.getElementById('lvlImage').src = "img/connector2.svg";
    }
